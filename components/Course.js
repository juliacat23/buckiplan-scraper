                            ...
                            <div onClick={() => showModal(true)}>
                                ...
                                >
                                    <div
                                        className={
                                            valid === '1'
                                                ? classes.highlightCourseName
                                                : classes.invalidHighlight
                                        }
                                    >
                                        {coursePrefix}
                                    </div>
                ...
                >
                    <div style={{ margin: '20px' }}>
                        <div style={{ display: 'flex' }}>
                            ...
                            >
                                <div className={classes.highlightCourseName}>
                                    {coursePrefix}
                                </div>{' '}
                                {courseName}
                            </div>
