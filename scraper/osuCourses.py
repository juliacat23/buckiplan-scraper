...
def saveCourses():
    courses = getCourses(subjects=getSubjects(driver_path="/Users/julia/Projects/OSU-Course-Scraper/chromedriver", url="https://courses.osu.edu/psp/csosuct/EMPLOYEE/PUB/c/COMMUNITY_ACCESS.CLASS_SEARCH.GBL?"))
