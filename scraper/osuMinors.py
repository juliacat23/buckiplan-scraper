...
def getMinors(driver_path, url): 
    ...
    ids = driver.find_elements(By.CSS_SELECTOR, "h3")
    for id_text in ids:
    ...
    df.to_json('data/minors.json', orient='records')

    print(df)


getMinors(driver_path="/Users/julia/Projects/buckiplan/scraper/chromedriver", url='https://artsandsciences.osu.edu/academics/programs#minors-alpha')
